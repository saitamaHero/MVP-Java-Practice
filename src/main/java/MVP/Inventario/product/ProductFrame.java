 ...
 * @author Dionicio
 */
public class ProductFrame extends javax.swing.JFrame implements ProductContract.View{
    ...
    private void buttonSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonSaveMouseClicked
        ...
        this.presenter.onSave(this.presenter.getProductFromView());
    ...
    public BigDecimal getPrice() {
        try {
            this.txtPrice.commitEdit();
        } catch (ParseException ex) {
            return BigDecimal.ZERO;
        }
        
        return new BigDecimal(this.txtPrice.getValue().toString());
    }
